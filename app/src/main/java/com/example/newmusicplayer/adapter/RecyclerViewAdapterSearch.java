...
public class RecyclerViewAdapterSearch extends RecyclerView.Adapter<RecyclerViewAdapterSearch.ViewHolder> {
    ...
    public RecyclerViewAdapterSearch(ArrayList<LibraryBean> albums, Context context){
        this.albums = albums;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder,final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                controller.navigate(R.id.action_fragmentSearch_to_fragmentAlbumList, bundle);
            }
        });
    }
