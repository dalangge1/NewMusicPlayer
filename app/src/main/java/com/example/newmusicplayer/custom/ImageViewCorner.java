...
public class ImageViewCorner extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public ImageViewCorner(Context context) {
        super(context);
        init();
    }

    public ImageViewCorner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ImageViewCorner(Context context, AttributeSet attrs, int defStyleAttr) {
